              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input v-model="nombre" readonly
                    @blur='getProduct' @focus='div_aparecer=false'
            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <br>
                  <div class="progress">
                    <div id="barraprogreso" class="progress-bar" role="progressbar" aria-valuenow="0" aria-valuemin="0" 
       ...
       <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                   ...
                   <a href="{{ route('admin.product.edit',$producto->slug) }}" class="btn btn-outline-success">Editar</a>
