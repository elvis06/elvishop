...
<div id="confirmareliminar" class="row">
    ...
    <div class="card">
        ...
        <a class="btn btn-primary m-2 float-right" href="{{ route('admin.product.create') }}">Crear</a>
        @endcan
        <table class="table1 table-head-fixed">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a class="btn btn-default" href="{{ route('admin.product.show',$producto->slug) }}">Ver</a>
                    </td>
                    @endcan
