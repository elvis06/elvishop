    ...
    <div class="bg-img-hero mb-14" style="background-image: url(../../assets/img/1920x600/img1.jpg);">
        <div class="container">
            <div class="flex-content-center max-width-620-lg flex-column mx-auto text-center min-height-564">
                <h1 class="h1 font-weight-bold" style="color: #FFF;">Sobre Nosotros</h1>
                <p class="text-gray-39 font-size-18 text-lh-default" style="color: #FFF;">Nuestro objetivo es "Cuidar tu Salud" y mejorar tu calidad de vida.</p>
            </div>
        </div>
    </div>
    <div class="container">
