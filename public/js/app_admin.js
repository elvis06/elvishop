      ...
      if (this.slug) {
        ...
        axios.get(url).then(function (response) {
          ...
          if (_this.div_mensajeslug === 'Slug disponible') {
            ...
            _this.deshabillitar_boton = 0;
          } else {
            _this.div_clase_slug = 'badge badge-danger';
            _this.deshabillitar_boton = 1;
          }
        ...
        this.div_mensajeslug = 'Debe escribir una categoría';
        this.deshabillitar_boton = 1;
...
module.exports = __webpack_require__(/*! C:\laragon\www\elvishop\resources\js\app_admin.js */"./resources/js/app_admin.js");
