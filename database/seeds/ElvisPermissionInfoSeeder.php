...
use App\User;
use App\ElvisPermission\Models\Role;
use Illuminate\Support\Facades\Hash;
use App\ElvisPermission\Models\Permission;
use Illuminate\Support\Facades\DB;

class ElvisPermissionInfoSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $permission = Permission::create([
            'name' => 'Edit own user',
            'slug' => 'userown.edit',
            'description' => 'A user can edit pwn user'
        ]);
